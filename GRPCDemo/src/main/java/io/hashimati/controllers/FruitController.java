...
public class FruitController {
    ...
    @Version("1")
    @Operation(summary = "Updating a fruit.",
            description = "A REST service, which updates a Fruit objects to the database by Name, This service will only update these attributes {name, quantity, price}.",
    ...
    public Long updateName(@SpanTag("updateupdateby.Name.fruit") @QueryValue("query") String query,  @Body Fruit body )
    {
        ...
        return fruitService.updateByName(query, body.getName(), body.getQuantity(), body.getPrice() );
